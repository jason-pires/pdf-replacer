# exemplo_v2_inteligente.py
# Script de uso - PDF Processor V2 COM DETECÇÃO INTELIGENTE DE COR

from pdf_processor_v2_com_fonte_inteligente import processar_pdf_inteligente
from placeholders_valores_completo import placeholders_valores

# ============================================================================
# EXECUTAR PIPELINE COMPLETO COM DETECÇÃO INTELIGENTE
# ============================================================================

if __name__ == "__main__":
    
    print("\n" + "="*80)
    print("PDF PROCESSOR V2 - VERSÃO COM DETECÇÃO INTELIGENTE DE COR")
    print("="*80)
    ...
    if sucesso:
        ...
        print("Arquivo: Contrato_Preenchido_Inteligente.pdf")
