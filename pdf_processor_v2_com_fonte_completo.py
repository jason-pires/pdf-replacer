# pdf_processor_v2_com_fonte_completo.py
# VERSÃO COMPLETA - 5 FUNÇÕES + FUNÇÃO AUXILIAR COM FONTE PLUS JAKARTA SANS
# Implementação completa com suporte a Plus Jakarta Sans
...
# ============================================================================
# FUNÇÃO 4: INSERIR TEXTOS COM FONTE PLUS JAKARTA SANS
# ============================================================================
...
def processar_pdf_completo(pdf_path: str, placeholders_valores: Dict[str, str],
    ...
    print("\n" + "🚀 "*35)
    print("PIPELINE COMPLETO - PDF PROCESSOR V2 COM FONTE")
    print("🚀 "*35 + "\n")
